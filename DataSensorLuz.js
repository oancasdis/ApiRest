...
app.get("/api/v1/sensor_data/DLobtenerUno/:id/:sensorApiKey/:companyApiKey", (req, res) => {
...
app.get("/api/v1/sensor_data/DLobtenerTodos/:sensorApiKey/:companyApiKey", (req, res) => {
    db.serialize(function() {
