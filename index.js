...
app.delete('/api/v1/location/LborrarUno/:companyApiKey/:id', Location)
...
app.get('/api/v1/sensor/SobtenerUno/:sensorApiKey/:id', Sensor)
app.get('/api/v1/sensor/SobtenerTodos/:sensorApiKey', Sensor)
app.delete('/api/v1/sensor/SborrarUno/:sensorApiKey/:id', Sensor)
...
app.get('/api/v1/sensor_data/DLobtenerUno/:id/:sensorApiKey/:companyApiKey', DataLuz)
app.get('/api/v1/sensor_data/DLobtenerTodos/:sensorApiKey/:companyApiKey', DataLuz)
